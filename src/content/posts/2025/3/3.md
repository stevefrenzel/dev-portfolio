...
Whenever possible, you should rather provide the accessible name through the interactive HTML element itself. Check out the articles in the [TL;DR](#tldr) section by Adrian and Eric for a better understanding of the issue.
