...
image:
    url: ../../images/blog/3/woman-calculating.jpg
    alt: "Woman calculating things in her head, asking herself: Why call it anchor, when it is a link?"
---

import { Image } from 'astro:assets';
import womanCalculating from '@images/blog/3/woman-calculating.jpg';
...
<a href={womanCalculating.src}>
    <Image alt="Woman calculating things in her head, asking herself: Why call it anchor, when it is a link?" src={womanCalculating}/>
</a>
