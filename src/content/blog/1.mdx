...
import thumbnail from '@images/blog/best-of-2023-so-far-thumbnail.png'
import circaSurvive from '@images/blog/circa-survive-two-dreams.jpeg'
import graphicNature from '@images/blog/graphic-nature-a-mind-waiting-to-die.jpeg'
import acres from '@images/blog/acres-burning-throne.jpeg'
import lambert from '@images/blog/lambert-open.jpeg'
import m83 from '@images/blog/m83-fantasy.jpeg'
import meshuggah from '@images/blog/meshugga-violent-sleep.jpeg'
...
<a href={circaSurvive.src}>
    <Image alt="Album artwork for Two Dreams by Circa Survive" src={circaSurvive}/>
</a>
...
<a href={graphicNature.src}>
    <Image alt="Album artwork for A Mind Waiting To Die by Graphic Nature" src={graphicNature}/>
</a>
...
<a href={acres.src}>
    <Image alt="Album artwork for Burning Throne by Acres" src={acres}/>
</a>
...
<a href={lambert.src}>
    <Image alt="Album artwork for Open by Lambert" src={lambert}/>
</a>
...
<a href={m83.src}>
    <Image alt="Album artwork for Fantasy by M83" src={m83}/>
</a>
...
<a href={meshuggah.src}>
    <Image alt="Album artwork for The Violent Sleep of Reason by Meshuggah" src={meshuggah}/>
</a>
